...
- Ramayana Game procedural Rama stand-in character, bow, and quiver - authored in `src/assets/characters/ramaStandIn.ts` for this repository and dedicated to CC0-1.0.
